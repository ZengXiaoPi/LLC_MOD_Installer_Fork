...
namespace LLC_MOD_Installer_Fork
{
    public partial class MainForm : Form
    {
        ...
        private void MainForm_Load(object sender, EventArgs e)
        {
            ...
            // 提示
            MessageBox.Show("请注意，本版本不是官方版本！\n如果出现故障，请前往我的仓库提交issue。\n程序拥有三个节点，如果你没有网络工具，请优先选择镜像节点。","注意事项",MessageBoxButtons.OK);
        ...
        {
            noteLabel.Text = "正在下载并打开NET 6.0流程";
        ...
        private void findLCC()
        {
            ...
            if (string.IsNullOrEmpty(limbusCompanyDir))
            {
                ...
                dialog.Description = "请选择你的边狱公司游戏路径（steam目录/steamapps/common/Limbus Company）请不要选择LimbusCompany_Data！";
